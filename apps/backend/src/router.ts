...
import {
  ...
  createTranslationBranchHandler,
  createRevisionBranchHandler,
  mergeRevisionIntoSourceHandler,
  promoteRevisionToVariantHandler,
  markTranslationCaughtUpHandler,
...
export const router = implement(contract).router({
  ...
  createTranslationBranch: createTranslationBranchHandler,
  createRevisionBranch: createRevisionBranchHandler,
  mergeRevisionIntoSource: mergeRevisionIntoSourceHandler,
  promoteRevisionToVariant: promoteRevisionToVariantHandler,
  markTranslationCaughtUp: markTranslationCaughtUpHandler,
