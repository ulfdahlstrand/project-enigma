...
import {
  ...
  archiveResumeBranchHandler,
  saveResumeVersionHandler,
  revertCommitHandler,
  rebaseTranslationOntoSourceHandler,
  rebaseRevisionOntoSourceHandler,
...
export const router = implement(contract).router({
  ...
  archiveResumeBranch: archiveResumeBranchHandler,
  revertCommit: revertCommitHandler,
  rebaseTranslationOntoSource: rebaseTranslationOntoSourceHandler,
  rebaseRevisionOntoSource: rebaseRevisionOntoSourceHandler,
