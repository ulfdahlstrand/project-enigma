...
import {
  ...
  updateResumeHandler,
  deleteResumeHandler,
  createResumeSkillGroupHandler,
  updateResumeSkillGroupHandler,
  createResumeSkillHandler,
  updateResumeSkillHandler,
...
export const router = implement(contract).router({
  ...
  createResumeSkillGroup: createResumeSkillGroupHandler,
  updateResumeSkillGroup: updateResumeSkillGroupHandler,
